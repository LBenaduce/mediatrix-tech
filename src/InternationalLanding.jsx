...
const portfolio = [
  { name: "AgriClimate Pro", industry: "AgTech · Climate Intelligence", problem: "Agricultural teams needed climate information that was easier to use in day-to-day decisions.", solution: "A responsive AgTech experience that turns complex climate data into clear decision-support views.", impact: "100% Mobile Optimized", projectUrl: "https://agriclimatepro.com/" },
  { name: projectNameTranslations.en.autoRepairShop, industry: "Service Business · Home Services", problem: "A service business needed a credible online presence that explained its work and made contact effortless.", solution: "A focused website with clear services, trust-building content and direct lead contact paths.", impact: "Faster Lead Contact", projectUrl: "https://frasson-farois.vercel.app/" },
