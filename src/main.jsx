  ...
  return (
    <section className="project-comparison" aria-labelledby="comparison-title">
      ...
      <div className={`comparison-panel ${showAfter ? "is-after" : "is-before"}`} aria-live="polite">
        ...
        {labels.comparisonAttribution && <footer>{labels.comparisonAttribution}</footer>}
        <img src="/frasson-llc-demo-optimized.jpg" alt="" width="800" height="456" loading="lazy" aria-hidden="true" />
      </div>
    </section>
  );
}
