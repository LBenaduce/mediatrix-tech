...
export const translations = {
  "pt-BR": {
    ...
    contact: {
      ...
      channels: [["WhatsApp Brasil", "Atendimento em português"], ["WhatsApp Estados Unidos", "Atendimento em inglês"], ["E-mail", "mediatrixtech@proton.me"], ["Perfil na Upwork", "Projetos internacionais"]],
  ...
  en: {
    ...
    servicesSection: { eyebrow: "Services", title: "Everything your brand needs to make a strong impression.", description: "Three clear solutions tailored to your goals and stage of business." },
    services: [
    ...
    contact: {
      ...
      channels: [["WhatsApp Brazil", "Service in Portuguese"], ["WhatsApp United States", "Service in English"], ["Email", "mediatrixtech@proton.me"], ["Upwork profile", "International projects"]],
  ...
  es: {
    ...
    servicesSection: { eyebrow: "Servicios", title: "Lo esencial para presentar tu marca con calidad.", description: "Tres soluciones claras, adaptadas a los objetivos y al momento de tu negocio." },
    services: [
  ...
  "zh-CN": {
    ...
    servicesSection: { eyebrow: "服务", title: "以专业品质呈现品牌所需的一切。", description: "三项清晰的解决方案，契合您的目标与业务发展阶段。" },
    services: [{ id: "web", title: "网站开发", description: "快速、响应式，并在各种屏幕上都易于使用的网站。", benefit: "将访问转化为新的商机。" }, { id: "photo", title: "图片编辑", description: "适用于产品、活动和社交媒体的专业修图。", benefit: "让品牌在每张图片中更具吸引力。" }, { id: "video", title: "视频剪辑", description: "为品牌、创作者和活动制作清晰且引人入胜的视频。", benefit: "抓住注意力，更有效地传达信息。" }],
