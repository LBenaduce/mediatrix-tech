...
const easterEggTranslations = {
  en: {
    ...
    lab: { title: "MEDIATRIX LAB", accessGranted: "> access granted", lead: "Experimental digital solutions.", congratulations: "Congratulations! Your curiosity unlocked this secret area.", storyPrompt: "The key is in the footer! Capture the discovery and share it in your Story.", close: "Close" },
    modal: { eyebrow: "Achievement unlocked", close: "Close the {achievement} achievement dialog" },
    share: {
      regionLabel: "Share the {achievement} achievement", shareAria: "Share the {achievement} achievement on an Instagram Story",
      creating: "Creating Story…", shareButton: "Share to Instagram Story", copyAria: "Copy the suggested Instagram Story text", copied: "Copied!", copyButton: "Copy Story text",
      ...
      copySuccess: "Story text copied.", copyFailure: "We couldn’t copy the Story text automatically. Please try again.", shareCompleted: "Your device completed the share action. You still control whether the Story is published.",
      ...
      fallbackInstructions: "Story image saved. Open Instagram, create a new Story, select the image, and mention @mediatrixtech.",
  ...
  "pt-BR": {
    ...
    lab: { title: "LABORATÓRIO MEDIATRIX", accessGranted: "> acesso concedido", lead: "Soluções digitais experimentais.", congratulations: "Parabéns! Sua curiosidade desbloqueou esta área secreta.", storyPrompt: "A chave está no rodapé! Registre a descoberta e compartilhe no seu Story.", close: "Fechar" },
  ...
  "zh-CN": {
    ...
    story: { discovery: "我在 Mediatrix Tech 网站发现了一个隐藏彩蛋！", question: "你也能找到它吗？", achievementUnlocked: "成就已解锁", secretFound: "> 已发现秘密_" }, notFound: { pageTitle: "404 | Mediatrix Tech", homeAria: "Mediatrix Tech 首页", code: "HTTP / 信号丢失", message: "这个页面逃到了另一个维度。", returnHome: "返回首页", objectAria: "交互式代码对象。连续激活五次即可调查。", objectHint: "不稳定对象" }, console: "你打开了控制台。很好。\n好奇的人会创造更好的作品。\n创造。连接。转化。",
  },
  hi: {
    common: { achievementUnlocked: "उपलब्धि अनलॉक हुई: {achievement}" }, achievements: { digitalExplorer: { name: "डिजिटल खोजकर्ता", description: "आपने कुछ ऐसा खोजा जो मेन्यू में नहीं था।" }, bugHunter: { name: "बग हंटर", description: "आपने खोए हुए पेज पर एक अस्थिर ऑब्जेक्ट ढूँढ लिया।" } }, lab: { title: "MEDIATRIX प्रयोगशाला", accessGranted: "> पहुँच स्वीकृत", lead: "प्रयोगात्मक डिजिटल समाधान।", congratulations: "बधाई! आपकी जिज्ञासा ने इस गुप्त क्षेत्र को अनलॉक कर दिया।", storyPrompt: "कुंजी फ़ुटर में है! इस खोज को सहेजें और अपनी Story में साझा करें।", close: "बंद करें" }, modal: { eyebrow: "उपलब्धि अनलॉक हुई", close: "{achievement} उपलब्धि बंद करें" },
...
export const translations = {
  "pt-BR": {
    ...
    metaTitle: "Criação de sites profissionais | Mediatrix Tech",
    metaDescription: "Sites rápidos, responsivos e personalizados para pequenas empresas, profissionais, eventos e agronegócio em Santa Maria, no Brasil e no exterior.",
    ...
    quote: "Solicitar uma avaliação",
    hero: {
      logoAlt: "Logo da Mediatrix Tech",
      title: "Mais clientes. Mais receita. Crescimento da receita até 27% mais rápido.*",
      footnote: "*Com base em uma pesquisa da Deloitte Access Economics que compara PMEs com presença digital avançada a empresas sem presença online.",
      primaryCta: "Solicitar uma avaliação",
      secondaryCta: "Ver projetos",
    },
    servicesSection: {
      eyebrow: "Serviços",
      title: "Soluções digitais para apresentar, operar e desenvolver seu negócio.",
      description: "Do primeiro site a uma solução sob medida, cada projeto parte de uma necessidade concreta e de um escopo claro.",
    },
    services: [
      { id: "site", title: "Sites profissionais e institucionais", shortTitle: "Sites profissionais", description: "Sites rápidos e responsivos para explicar seus serviços, fortalecer a confiança e facilitar o contato.", benefit: "Uma presença digital própria, clara e preparada para crescer." },
      { id: "landing", title: "Landing pages", description: "Páginas focadas em campanhas, lançamentos, serviços ou captação de novos contatos.", benefit: "Uma mensagem objetiva com um próximo passo fácil de entender." },
      { id: "custom", title: "Sistemas e soluções personalizadas", shortTitle: "Soluções personalizadas", description: "Ferramentas simples, formulários, painéis e fluxos digitais desenvolvidos conforme a rotina da empresa.", benefit: "Menos trabalho manual e uma operação mais organizada." },
      { id: "media", title: "Edição de imagens, vídeos e áudio", shortTitle: "Edição de mídia", description: "Tratamento de conteúdo para produtos, eventos, redes sociais, apresentações e materiais institucionais.", benefit: "Comunicação visual e sonora mais profissional e consistente." },
      { id: "event", title: "Páginas para eventos com QR Code", shortTitle: "Sites para eventos", description: "Experiências personalizadas para convidados enviarem, aprovarem e compartilharem fotos e vídeos.", benefit: "Participação simples pelo celular, sem exigir aplicativo." },
      { id: "agri", title: "Soluções digitais para o agronegócio", shortTitle: "Agronegócio", description: "Sites, painéis e experiências digitais para apresentar operações, dados e serviços do setor agrícola.", benefit: "Tecnologia aplicada a informações úteis para o campo e para o negócio." },
      { id: "care", title: "Manutenção e atualização de sites", shortTitle: "Manutenção", description: "Ajustes de conteúdo, melhorias técnicas e acompanhamento para manter o site seguro e atual.", benefit: "Seu site continua funcionando bem depois da entrega." },
    ],
    ...
    projects: [
      ...
      { name: "Oficina Mecânica", category: "Desenvolvimento Web · Serviços Automotivos", description: "Site responsivo para apresentar os serviços da oficina e facilitar o contato com clientes da região." },
    ],
    company: {
      eyebrow: "Empresa", title: "Tecnologia aplicada a objetivos de negócio.", description: "A Mediatrix Tech combina desenvolvimento, conteúdo e atendimento direto para transformar necessidades reais em soluções digitais úteis.",
      localSeo: { text: "A Mediatrix Tech desenvolve sites e soluções digitais para empresas de Santa Maria, do Rio Grande do Sul e de outras regiões do Brasil e do mundo.", link: "Criação de sites em Santa Maria, RS" },
      facts: [
      ...
      highlights: ["Empresa familiar", "Soluções digitais", "Cuidado e clareza", "No mundo todo"],
    },
    contact: {
      ...
      channels: [["WhatsApp", "+1 305 992 0833"], ["WhatsApp", "+55 55 99935-7388"], ["E-mail", "mediatrixtech@proton.me"], ["Perfil na Upwork", "Projetos internacionais"]],
  ...
  en: {
    ...
    metaTitle: "Professional websites for small businesses | Mediatrix Tech",
    metaDescription: "Fast, responsive and personalized websites for small businesses, service providers, events and agricultural companies worldwide.",
    ...
    hero: { logoAlt: "Mediatrix Tech logo", title: "More clients. More income. Up to 27% faster revenue growth.*", footnote: "*Based on Deloitte Access Economics research comparing advanced digitally engaged SMBs with offline businesses.", primaryCta: "Request a free website review", secondaryCta: "View our work" },
    ...
    services: [
      { id: "site", title: "Professional and company websites", shortTitle: "Business websites", description: "Fast, responsive websites that explain your services, build trust and make it easy to get in touch.", benefit: "A clear online presence your business can keep building on." },
      { id: "landing", title: "Landing pages", description: "Focused pages for campaigns, launches, individual services and lead generation.", benefit: "A direct message with an easy next step for visitors." },
      { id: "custom", title: "Custom systems and digital solutions", shortTitle: "Custom tools", description: "Simple tools, forms, dashboards and workflows developed around the way your business operates.", benefit: "Less manual work and a more organized process." },
      { id: "media", title: "Image, video and audio editing", shortTitle: "Media editing", description: "Professional content editing for products, events, social media, presentations and company materials.", benefit: "More consistent visual and audio communication." },
      { id: "event", title: "QR Code event websites", shortTitle: "QR event sites", description: "Custom experiences for guests to upload, approve and share photos and videos from their phones.", benefit: "Simple participation without requiring an app." },
      { id: "agri", title: "Digital solutions for agriculture", shortTitle: "Agriculture", description: "Websites, dashboards and digital experiences that present agricultural operations, services and data.", benefit: "Technology applied to useful information for the field and the business." },
      { id: "care", title: "Website maintenance and updates", shortTitle: "Maintenance", description: "Content changes, technical improvements and ongoing care to keep your website current and reliable.", benefit: "Your website keeps working well after launch." },
    ],
    ...
    projects: [
      ...
      { name: "Auto Repair Shop", category: "Web Development · Automotive Services", description: "A responsive website presenting the repair shop’s services and making it easy for local customers to get in touch." },
    ],
    company: { eyebrow: "Company", title: "Technology applied to business goals.", description: "Mediatrix Tech combines development, content and direct communication to turn real needs into useful digital solutions.", localSeo: { text: "Mediatrix Tech develops websites and digital solutions for businesses in Santa Maria, Rio Grande do Sul, other regions of Brazil and worldwide.", link: "Website development in Santa Maria, RS" }, facts: [["Who we are", "We are a family business, created to turn good ideas into useful, beautiful and functional digital solutions. Because beauty matters too."], ["What we do", "We develop digital projects with care, elegance and attention to detail. For us, quality and responsibility always come first."], ["How we work", "We work with realistic timelines, clear communication and careful review at every stage. We do not deliver just to finish: we deliver when the work is truly well done."], ["Where we work", "On planet Earth and its surroundings."]], highlights: ["Family business", "Digital solutions", "Care and clarity", "Worldwide"] },
    contact: {
      eyebrow: "Contact", title: "Tell us what your business needs to improve online.", description: "Send a message to request an initial review, ask a question or discuss a new project.", channelsLabel: "Contact channels",
      channels: [["WhatsApp", "+1 305 992 0833"], ["WhatsApp", "+55 55 99935-7388"], ["Email", "mediatrixtech@proton.me"], ["Upwork profile", "International projects"]],
  ...
  es: {
    ...
    hero: { logoAlt: "Logotipo de Mediatrix Tech", title: "Más clientes. Más ingresos. Crecimiento de los ingresos hasta un 27 % más rápido.*", footnote: "*Basado en una investigación de Deloitte Access Economics que compara pymes con una presencia digital avanzada con empresas sin presencia en línea.", services: "Ver servicios" },
    ...
    projects: [{ name: "AgriClimate Pro", category: "Desarrollo Web · AgTech", description: "Una experiencia digital que apoya decisiones agrícolas con datos climáticos." }, { name: "Frasson LLC", category: "Desarrollo Web", description: "Un sitio empresarial claro, creado para presentar servicios y facilitar el contacto." }, { name: "Event QR Code", category: "Experiencia digital para eventos", description: "Un flujo sencillo con código QR para que los invitados envíen fotos y videos." }, { name: "Cafeteria", category: "Desarrollo Web · Gastronomía", description: "Un sitio cálido y responsivo para presentar la experiencia de la cafetería y facilitar el acceso al menú." }, { name: "Taller Mecánico", category: "Desarrollo Web · Servicios Automotrices", description: "Un sitio responsivo que presenta los servicios del taller y facilita el contacto con clientes de la zona." }],
    company: { eyebrow: "Empresa", title: "Sobre Mediatrix Tech", description: "Creatividad y tecnología trabajando juntas para conectar marcas y personas.", localSeo: { text: "Mediatrix Tech desarrolla sitios web y soluciones digitales para empresas de Santa Maria, Rio Grande do Sul, otras regiones de Brasil y del mundo.", link: "Creación de sitios web en Santa Maria, RS" }, facts: [["Quiénes somos", "Somos una empresa familiar, creada para transformar buenas ideas en soluciones digitales útiles, bonitas y funcionales. Porque la belleza también importa."], ["Qué hacemos", "Desarrollamos proyectos digitales con cuidado, elegancia y atención a los detalles. Para nosotros, la calidad y la responsabilidad siempre son lo primero."], ["Cómo trabajamos", "Trabajamos con plazos realistas, comunicación clara y una revisión cuidadosa en cada etapa. No entregamos solo por terminar: entregamos cuando el trabajo está realmente bien hecho."], ["Dónde trabajamos", "En el planeta Tierra y sus alrededores."]], highlights: ["Empresa familiar", "Soluciones digitales", "Cuidado y claridad", "En todo el mundo"] },
    contact: { eyebrow: "Contacto", title: "¿Hablamos de tu proyecto?", description: "Elige el canal más cómodo o envíanos un mensaje mediante el formulario.", channelsLabel: "Canales de contacto", channels: [["WhatsApp", "+1 305 992 0833"], ["WhatsApp", "+55 55 99935-7388"], ["Correo electrónico", "mediatrixtech@proton.me"], ["Perfil en Upwork", "Proyectos internacionales"]], form: { title: "Envía un mensaje", description: "Cuéntanos brevemente qué necesitas.", name: "Nombre", email: "Correo electrónico", service: "Servicio de interés", chooseService: "Selecciona un servicio", message: "Mensaje", send: "Enviar mensaje", sending: "Enviando...", success: "Mensaje enviado correctamente. Nos pondremos en contacto pronto.", error: "No pudimos enviar tu mensaje. Inténtalo de nuevo o escríbenos por WhatsApp.", subject: "Nuevo mensaje desde el sitio de Mediatrix Tech" } },
  ...
  fr: {
    ...
    hero: { logoAlt: "Logo de Mediatrix Tech", title: "Plus de clients. Plus de revenus. Une croissance du chiffre d’affaires jusqu’à 27 % plus rapide.*", footnote: "*D’après une étude de Deloitte Access Economics comparant les PME très avancées sur le plan numérique aux entreprises hors ligne.", services: "Voir les services" },
    servicesSection: { eyebrow: "Services", title: "L’essentiel pour présenter votre marque avec qualité.", description: "Quatre solutions claires, adaptées à vos objectifs et au stade de développement de votre entreprise." },
    services: [{ id: "web", title: "Développement web", description: "Des sites rapides, adaptatifs et faciles à utiliser sur tous les écrans.", benefit: "Transformez les visites en nouvelles opportunités." }, { id: "photo", title: "Retouche photo", description: "Des retouches professionnelles pour produits, événements et réseaux sociaux.", benefit: "Valorisez votre marque dans chaque image." }, { id: "video", title: "Montage vidéo", description: "Des vidéos claires et attrayantes pour marques, créateurs et événements.", benefit: "Captez l’attention et communiquez mieux." }, { id: "audio", title: "Montage audio", description: "Nettoyage, mixage et mastering pour vidéos, podcasts et contenus numériques.", benefit: "Offrez à chaque projet un son clair et professionnel." }],
    ...
    projects: [{ name: "AgriClimate Pro", category: "Développement Web · AgTech", description: "Une expérience numérique qui facilite les décisions agricoles grâce aux données climatiques." }, { name: "Frasson LLC", category: "Développement Web", description: "Un site d’entreprise clair, conçu pour présenter les services et faciliter le contact." }, { name: "Event QR Code", category: "Expérience numérique événementielle", description: "Un parcours simple par QR Code permettant aux invités d’envoyer photos et vidéos." }, { name: "Cafeteria", category: "Développement Web · Restauration", description: "Un site chaleureux et adaptatif qui présente l’expérience du café et facilite l’accès au menu." }, { name: "Garage Automobile", category: "Développement Web · Services Automobiles", description: "Un site adaptatif qui présente les services du garage et facilite le contact avec les clients locaux." }],
    company: { eyebrow: "Entreprise", title: "À propos de Mediatrix Tech", description: "Créativité et technologie réunies pour rapprocher les marques et les personnes.", localSeo: { text: "Mediatrix Tech conçoit des sites web et des solutions numériques pour les entreprises de Santa Maria, du Rio Grande do Sul, d’autres régions du Brésil et du monde entier.", link: "Création de sites web à Santa Maria, RS" }, facts: [["Qui sommes-nous ?", "Nous sommes une entreprise familiale, créée pour transformer de bonnes idées en solutions numériques utiles, belles et fonctionnelles. Parce que la beauté compte aussi."], ["Ce que nous faisons", "Nous concevons des projets numériques avec soin, élégance et souci du détail. Pour nous, la qualité et la responsabilité passent toujours en premier."], ["Notre méthode", "Nous travaillons avec des délais réalistes, une communication claire et une vérification attentive à chaque étape. Nous ne livrons pas simplement pour terminer : nous livrons lorsque le travail est réellement bien fait."], ["Où intervenons-nous ?", "Sur la planète Terre et aux alentours."]], highlights: ["Entreprise familiale", "Solutions numériques", "Soin et clarté", "Dans le monde entier"] },
    contact: { eyebrow: "Contact", title: "Parlons de votre projet.", description: "Choisissez le canal le plus pratique ou envoyez-nous un message via le formulaire.", channelsLabel: "Canaux de contact", channels: [["WhatsApp", "+1 305 992 0833"], ["WhatsApp", "+55 55 99935-7388"], ["E-mail", "mediatrixtech@proton.me"], ["Profil Upwork", "Projets internationaux"]], form: { title: "Envoyer un message", description: "Expliquez-nous brièvement ce dont vous avez besoin.", name: "Nom", email: "E-mail", service: "Service recherché", chooseService: "Sélectionnez un service", message: "Message", send: "Envoyer le message", sending: "Envoi en cours...", success: "Message envoyé. Nous vous répondrons bientôt.", error: "Votre message n’a pas pu être envoyé. Réessayez ou contactez-nous sur WhatsApp.", subject: "Nouveau message depuis le site Mediatrix Tech" } },
  ...
  de: {
    ...
    hero: { logoAlt: "Logo von Mediatrix Tech", title: "Mehr Kunden. Mehr Umsatz. Bis zu 27 % schnelleres Umsatzwachstum.*", footnote: "*Basierend auf einer Studie von Deloitte Access Economics, die digital fortschrittliche KMU mit Offline-Unternehmen vergleicht.", services: "Leistungen ansehen" },
    ...
    services: [{ id: "web", title: "Webentwicklung", description: "Schnelle, responsive Websites, die auf jedem Bildschirm leicht zu bedienen sind.", benefit: "Machen Sie Websitebesucher zu neuen Geschäftschancen." }, { id: "photo", title: "Fotobearbeitung", description: "Professionelle Bearbeitung für Produkte, Veranstaltungen und soziale Medien.", benefit: "Setzen Sie Ihre Marke in jedem Bild in Szene." }, { id: "video", title: "Videobearbeitung", description: "Klare, ansprechende Videos für Marken, Kreative und Veranstaltungen.", benefit: "Gewinnen Sie Aufmerksamkeit und kommunizieren Sie besser." }, { id: "audio", title: "Audiobearbeitung", description: "Bereinigung, Mischung und Mastering für Videos, Podcasts und digitale Inhalte.", benefit: "Geben Sie jedem Projekt einen klaren, professionellen Klang." }],
    portfolioSection: { eyebrow: "Portfolio", title: "Ausgewählte Projekte.", description: "Arbeiten, die Klarheit, Erfahrung und Ergebnisse verbinden.", view: "Projekt ansehen", videoDemo: "Projekt-Demo", screenshot: "Projekt-Screenshot" },
    projects: [{ name: "AgriClimate Pro", category: "Webentwicklung · AgTech", description: "Eine digitale Lösung, die landwirtschaftliche Entscheidungen mit Klimadaten unterstützt." }, { name: "Frasson LLC", category: "Webentwicklung", description: "Eine klare Unternehmenswebsite zur Präsentation von Leistungen und für eine einfache Kontaktaufnahme." }, { name: "Event QR Code", category: "Digitale Event-Lösung", description: "Ein einfacher QR-Code-Ablauf, über den Gäste Fotos und Videos hochladen können." }, { name: "Cafeteria", category: "Webentwicklung · Gastronomie", description: "Eine einladende, responsive Website, die das Café-Erlebnis präsentiert und den Zugang zur Speisekarte erleichtert." }, { name: "Autowerkstatt", category: "Webentwicklung · Kfz-Service", description: "Eine responsive Website, die die Werkstattleistungen präsentiert und lokalen Kunden die Kontaktaufnahme erleichtert." }],
    company: { eyebrow: "Unternehmen", title: "Über Mediatrix Tech", description: "Kreativität und Technologie verbinden Marken und Menschen.", localSeo: { text: "Mediatrix Tech entwickelt Websites und digitale Lösungen für Unternehmen in Santa Maria, Rio Grande do Sul, anderen Regionen Brasiliens und weltweit.", link: "Website-Erstellung in Santa Maria, RS" }, facts: [["Wer wir sind", "Wir sind ein Familienunternehmen, das gegründet wurde, um gute Ideen in nützliche, schöne und funktionale digitale Lösungen zu verwandeln. Denn Schönheit ist ebenfalls wichtig."], ["Was wir tun", "Wir entwickeln digitale Projekte mit Sorgfalt, Eleganz und Liebe zum Detail. Qualität und Verantwortung stehen für uns immer an erster Stelle."], ["Wie wir arbeiten", "Wir arbeiten mit realistischen Zeitplänen, klarer Kommunikation und sorgfältiger Prüfung in jeder Phase. Wir liefern nicht einfach nur, um fertig zu werden: Wir liefern, wenn die Arbeit wirklich gut gemacht ist."], ["Wo wir arbeiten", "Auf dem Planeten Erde und in der Umgebung."]], highlights: ["Familienunternehmen", "Digitale Lösungen", "Sorgfalt und Klarheit", "Weltweit"] },
    contact: { eyebrow: "Kontakt", title: "Lassen Sie uns über Ihr Projekt sprechen.", description: "Wählen Sie den bequemsten Kanal oder senden Sie uns eine Nachricht über das Formular.", channelsLabel: "Kontaktmöglichkeiten", channels: [["WhatsApp", "+1 305 992 0833"], ["WhatsApp", "+55 55 99935-7388"], ["E-Mail", "mediatrixtech@proton.me"], ["Upwork-Profil", "Internationale Projekte"]], form: { title: "Nachricht senden", description: "Beschreiben Sie kurz, was Sie benötigen.", name: "Name", email: "E-Mail", service: "Gewünschte Leistung", chooseService: "Leistung auswählen", message: "Nachricht", send: "Nachricht senden", sending: "Wird gesendet...", success: "Nachricht erfolgreich gesendet. Wir melden uns in Kürze.", error: "Ihre Nachricht konnte nicht gesendet werden. Versuchen Sie es erneut oder kontaktieren Sie uns über WhatsApp.", subject: "Neue Nachricht von der Mediatrix-Tech-Website" } },
  ...
  "zh-CN": {
    ...
    hero: { logoAlt: "Mediatrix Tech 标志", title: "更多客户。更多收入。营收增长速度最高可提升 27%。*", footnote: "*基于 Deloitte Access Economics 的研究，该研究将数字化参与度高的中小企业与离线经营的企业进行了比较。", services: "查看服务" },
    servicesSection: { eyebrow: "服务", title: "以专业品质呈现品牌所需的一切。", description: "四项清晰的解决方案，契合您的目标与业务发展阶段。" },
    services: [{ id: "web", title: "网站开发", description: "打造快速、响应式且适配各种屏幕的网站。", benefit: "将访问转化为新的商机。" }, { id: "photo", title: "图片编辑", description: "适用于产品、活动和社交媒体的专业修图。", benefit: "让品牌在每张图片中更具吸引力。" }, { id: "video", title: "视频剪辑", description: "为品牌、创作者和活动制作清晰且引人入胜的视频。", benefit: "抓住注意力，更有效地传达信息。" }, { id: "audio", title: "音频编辑", description: "为视频、播客和数字内容提供降噪、混音与母带处理。", benefit: "让每个项目拥有清晰专业的声音。" }],
    portfolioSection: { eyebrow: "作品集", title: "精选项目。", description: "兼顾清晰表达、用户体验与实际成果的代表作品。", view: "查看项目", videoDemo: "项目演示", screenshot: "项目截图" },
    projects: [{ name: "AgriClimate Pro", category: "网站开发 · 农业科技", description: "利用气候数据辅助农业决策的数字化体验。" }, { name: "Frasson LLC", category: "网站开发", description: "简洁的企业网站，用于展示服务并方便客户联系。" }, { name: "Event QR Code", category: "活动数字体验", description: "宾客可通过二维码轻松上传照片和视频。" }, { name: "Cafeteria", category: "网站开发 · 餐饮", description: "温馨的响应式网站，展示咖啡馆体验并让访客轻松查看菜单。" }, { name: "汽车维修店", category: "网站开发 · 汽车服务", description: "响应式网站，用于展示维修服务并方便本地客户联系。" }],
    company: { eyebrow: "公司", title: "关于 Mediatrix Tech", description: "让创意与技术协同工作，连接品牌与人。", localSeo: { text: "Mediatrix Tech 为圣玛丽亚、南里奥格兰德州、巴西其他地区及全球企业开发网站和数字解决方案。", link: "圣玛丽亚（RS）网站开发" }, facts: [["我们是谁", "我们是一家家族企业，致力于将好创意转化为实用、美观且功能完善的数字解决方案。因为美也同样重要。"], ["我们做什么", "我们用心、优雅且注重细节地开发数字项目。对我们而言，质量与责任始终是第一位。"], ["我们的工作方式", "我们设定切合实际的时间安排，保持清晰沟通，并在每个阶段认真审核。我们不会为了完成而交付；只有真正做好了，才会交付。"], ["我们的服务范围", "地球及其周边地区。"]], highlights: ["家族企业", "数字化解决方案", "用心且清晰", "服务全球"] },
    contact: { eyebrow: "联系", title: "聊聊您的项目吧。", description: "请选择最方便的联系方式，或通过表单给我们留言。", channelsLabel: "联系方式", channels: [["WhatsApp", "+1 305 992 0833"], ["WhatsApp", "+55 55 99935-7388"], ["电子邮件", "mediatrixtech@proton.me"], ["Upwork 主页", "国际项目"]], form: { title: "发送消息", description: "请简要说明您的需求。", name: "姓名", email: "电子邮件", service: "感兴趣的服务", chooseService: "请选择一项服务", message: "消息", send: "发送消息", sending: "正在发送...", success: "消息已成功发送。我们会尽快与您联系。", error: "消息发送失败。请重试或通过 WhatsApp 联系我们。", subject: "来自 Mediatrix Tech 网站的新消息" } },
    rights: "版权所有。",
  },
  ...
  hi: {
    ...
    hero: { logoAlt: "Mediatrix Tech का लोगो", title: "ज़्यादा ग्राहक। ज़्यादा आय। राजस्व वृद्धि 27% तक तेज़।*", footnote: "*Deloitte Access Economics के शोध पर आधारित, जिसमें डिजिटल रूप से उन्नत लघु और मध्यम व्यवसायों की तुलना ऑफ़लाइन व्यवसायों से की गई है।", services: "सेवाएँ देखें" },
    servicesSection: { eyebrow: "सेवाएँ", title: "आपके ब्रांड को बेहतरीन ढंग से प्रस्तुत करने के लिए ज़रूरी समाधान।", description: "आपके लक्ष्य और व्यवसाय के चरण के अनुसार चार स्पष्ट समाधान।" },
    services: [{ id: "web", title: "वेब डेवलपमेंट", description: "तेज़, रेस्पॉन्सिव और हर स्क्रीन पर इस्तेमाल में आसान वेबसाइटें।", benefit: "वेबसाइट विज़िट को नए अवसरों में बदलें।" }, { id: "photo", title: "फ़ोटो एडिटिंग", description: "उत्पादों, आयोजनों और सोशल मीडिया के लिए पेशेवर एडिटिंग।", benefit: "हर तस्वीर में अपने ब्रांड को बेहतर दिखाएँ।" }, { id: "video", title: "वीडियो एडिटिंग", description: "ब्रांड, क्रिएटर और आयोजनों के लिए स्पष्ट और आकर्षक वीडियो।", benefit: "ध्यान आकर्षित करें और बेहतर संवाद करें।" }, { id: "audio", title: "ऑडियो एडिटिंग", description: "वीडियो, पॉडकास्ट और डिजिटल कंटेंट के लिए ऑडियो क्लीनअप, मिक्सिंग और मास्टरिंग।", benefit: "हर प्रोजेक्ट को साफ़ और पेशेवर ध्वनि दें।" }],
    ...
    projects: [{ name: "AgriClimate Pro", category: "वेब डेवलपमेंट · AgTech", description: "जलवायु डेटा से कृषि निर्णयों में मदद करने वाला डिजिटल अनुभव।" }, { name: "Frasson LLC", category: "वेब डेवलपमेंट", description: "सेवाएँ प्रस्तुत करने और संपर्क आसान बनाने के लिए तैयार स्पष्ट व्यावसायिक वेबसाइट।" }, { name: "Event QR Code", category: "आयोजनों के लिए डिजिटल अनुभव", description: "मेहमानों के लिए QR कोड से फ़ोटो और वीडियो भेजने का आसान तरीका।" }, { name: "Cafeteria", category: "वेब डेवलपमेंट · खाद्य एवं पेय", description: "कैफ़े के अनुभव को प्रस्तुत करने और मेन्यू तक आसान पहुँच देने वाली आकर्षक, रेस्पॉन्सिव वेबसाइट।" }, { name: "ऑटो रिपेयर शॉप", category: "वेब डेवलपमेंट · ऑटोमोटिव सेवाएँ", description: "वर्कशॉप की सेवाएँ प्रस्तुत करने और स्थानीय ग्राहकों के लिए संपर्क आसान बनाने वाली रेस्पॉन्सिव वेबसाइट।" }],
    company: { eyebrow: "कंपनी", title: "Mediatrix Tech के बारे में", description: "ब्रांड और लोगों को जोड़ने के लिए रचनात्मकता और तकनीक का मेल।", localSeo: { text: "Mediatrix Tech सांता मारिया, रियो ग्रांडे डो सुल, ब्राज़ील के अन्य क्षेत्रों और दुनिया भर के व्यवसायों के लिए वेबसाइट और डिजिटल समाधान विकसित करता है।", link: "सांता मारिया, RS में वेबसाइट निर्माण" }, facts: [["हम कौन हैं", "हम एक पारिवारिक कंपनी हैं, जिसकी स्थापना अच्छे विचारों को उपयोगी, सुंदर और कार्यक्षम डिजिटल समाधानों में बदलने के लिए की गई है। क्योंकि सुंदरता भी मायने रखती है।"], ["हम क्या करते हैं", "हम सावधानी, सुरुचि और बारीकियों पर ध्यान देते हुए डिजिटल परियोजनाएँ विकसित करते हैं। हमारे लिए गुणवत्ता और जिम्मेदारी हमेशा सबसे पहले आती हैं।"], ["हम कैसे काम करते हैं", "हम यथार्थवादी समय-सीमा, स्पष्ट संवाद और हर चरण में सावधानीपूर्वक समीक्षा के साथ काम करते हैं। हम केवल काम खत्म करने के लिए डिलीवर नहीं करते; हम तब डिलीवर करते हैं जब काम वास्तव में अच्छी तरह पूरा हो।"], ["हम कहाँ काम करते हैं", "पृथ्वी ग्रह और उसके आसपास।"]], highlights: ["पारिवारिक व्यवसाय", "डिजिटल समाधान", "सावधानी और स्पष्टता", "दुनिया भर में"] },
    contact: { eyebrow: "संपर्क", title: "आइए आपके प्रोजेक्ट के बारे में बात करें।", description: "सबसे सुविधाजनक माध्यम चुनें या फ़ॉर्म से हमें संदेश भेजें।", channelsLabel: "संपर्क माध्यम", channels: [["WhatsApp", "+1 305 992 0833"], ["WhatsApp", "+55 55 99935-7388"], ["ईमेल", "mediatrixtech@proton.me"], ["Upwork प्रोफ़ाइल", "अंतरराष्ट्रीय प्रोजेक्ट"]], form: { title: "संदेश भेजें", description: "संक्षेप में बताएँ कि आपको क्या चाहिए।", name: "नाम", email: "ईमेल", service: "रुचि की सेवा", chooseService: "एक सेवा चुनें", message: "संदेश", send: "संदेश भेजें", sending: "भेजा जा रहा है...", success: "संदेश सफलतापूर्वक भेजा गया। हम जल्द संपर्क करेंगे।", error: "संदेश नहीं भेजा जा सका। दोबारा कोशिश करें या WhatsApp पर संपर्क करें।", subject: "Mediatrix Tech वेबसाइट से नया संदेश" } },
  ...
  ar: {
    ...
    hero: { logoAlt: "شعار Mediatrix Tech", title: "المزيد من العملاء. المزيد من الإيرادات. نمو في الإيرادات أسرع بنسبة تصل إلى 27%.*", footnote: "*استنادًا إلى بحث أجرته Deloitte Access Economics يقارن الشركات الصغيرة والمتوسطة ذات التفاعل الرقمي المتقدم بالشركات غير المتصلة بالإنترنت.", services: "عرض الخدمات" },
    servicesSection: { eyebrow: "الخدمات", title: "كل ما تحتاج إليه علامتك التجارية لتظهر بجودة واحتراف.", description: "أربعة حلول واضحة تتكيف مع أهدافك ومرحلة نمو أعمالك." },
    services: [{ id: "web", title: "تطوير المواقع", description: "مواقع سريعة ومتجاوبة وسهلة الاستخدام على جميع الشاشات.", benefit: "حوّل الزيارات إلى فرص جديدة." }, { id: "photo", title: "تحرير الصور", description: "معالجة احترافية للمنتجات والفعاليات ووسائل التواصل الاجتماعي.", benefit: "أبرز علامتك التجارية في كل صورة." }, { id: "video", title: "تحرير الفيديو", description: "فيديوهات واضحة وجذابة للعلامات التجارية وصنّاع المحتوى والفعاليات.", benefit: "اجذب الانتباه وتواصل بصورة أفضل." }, { id: "audio", title: "تحرير الصوت", description: "تنقية الصوت ومزجه ومعالجته النهائية للفيديوهات والبودكاست والمحتوى الرقمي.", benefit: "امنح كل مشروع صوتًا واضحًا واحترافيًا." }],
    ...
    projects: [{ name: "AgriClimate Pro", category: "تطوير المواقع · التقنية الزراعية", description: "تجربة رقمية تدعم القرارات الزراعية بالاعتماد على بيانات المناخ." }, { name: "Frasson LLC", category: "تطوير المواقع", description: "موقع أعمال واضح صُمم لعرض الخدمات وتسهيل التواصل." }, { name: "Event QR Code", category: "تجربة رقمية للفعاليات", description: "مسار بسيط عبر رمز QR يتيح للضيوف إرسال الصور والفيديوهات." }, { name: "Cafeteria", category: "تطوير المواقع · الأغذية والمشروبات", description: "موقع دافئ ومتجاوب يعرض تجربة المقهى ويسهّل الوصول إلى قائمة الطعام." }, { name: "ورشة صيانة السيارات", category: "تطوير المواقع · خدمات السيارات", description: "موقع متجاوب يعرض خدمات الورشة ويسهّل تواصل العملاء المحليين." }],
    company: { eyebrow: "الشركة", title: "عن Mediatrix Tech", description: "الإبداع والتقنية يعملان معًا لربط العلامات التجارية بالناس.", localSeo: { text: "تطوّر Mediatrix Tech مواقع وحلولًا رقمية للشركات في سانتا ماريا وريو غراندي دو سول ومناطق أخرى من البرازيل والعالم.", link: "إنشاء مواقع في سانتا ماريا، RS" }, facts: [["من نحن", "نحن شركة عائلية أُنشئت لتحويل الأفكار الجيدة إلى حلول رقمية مفيدة وجميلة وعملية. لأن الجمال مهم أيضًا."], ["ما نفعله", "نطوّر مشاريع رقمية بعناية وأناقة واهتمام بالتفاصيل. بالنسبة لنا، تأتي الجودة والمسؤولية دائمًا في المقام الأول."], ["كيف نعمل", "نعمل وفق جداول زمنية واقعية، وتواصل واضح، ومراجعة دقيقة في كل مرحلة. لا نسلّم العمل لمجرد الانتهاء منه؛ بل نسلّمه عندما يكون متقنًا فعلًا."], ["أين نعمل", "على كوكب الأرض وما حوله."]], highlights: ["شركة عائلية", "حلول رقمية", "عناية ووضوح", "حول العالم"] },
    contact: { eyebrow: "التواصل", title: "لنتحدث عن مشروعك.", description: "اختر وسيلة التواصل الأنسب أو أرسل لنا رسالة عبر النموذج.", channelsLabel: "وسائل التواصل", channels: [["WhatsApp", "+1 305 992 0833"], ["WhatsApp", "+55 55 99935-7388"], ["البريد الإلكتروني", "mediatrixtech@proton.me"], ["حساب Upwork", "مشاريع دولية"]], form: { title: "إرسال رسالة", description: "أخبرنا بإيجاز بما تحتاج إليه.", name: "الاسم", email: "البريد الإلكتروني", service: "الخدمة المطلوبة", chooseService: "اختر خدمة", message: "الرسالة", send: "إرسال الرسالة", sending: "جارٍ الإرسال...", success: "تم إرسال رسالتك بنجاح. سنتواصل معك قريبًا.", error: "تعذر إرسال الرسالة. حاول مرة أخرى أو تواصل معنا عبر WhatsApp.", subject: "رسالة جديدة من موقع Mediatrix Tech" } },
