...
export const translations = {
  ...
  en: {
    ...
    company: { eyebrow: "Company", title: "Technology applied to business goals.", description: "Mediatrix Tech combines development, content and direct communication to turn real needs into useful digital solutions.", facts: [["Who we are", "We are a family business, created to turn good ideas into useful, beautiful and functional digital solutions. Because beauty matters too."], ["What we do", "We develop digital projects with care, elegance and attention to detail. For us, quality and responsibility always come first."], ["How we work", "We work with realistic timelines, clear communication and careful review at every stage. We do not deliver just to finish: we deliver when the work is truly well done."], ["Where we work", "On planet Earth and its surroundings."]] },
    contact: {
  ...
  es: {
    ...
    company: { eyebrow: "Empresa", title: "Sobre Mediatrix Tech", description: "Creatividad y tecnología trabajando juntas para conectar marcas y personas.", facts: [["Quiénes somos", "Somos una empresa familiar, creada para transformar buenas ideas en soluciones digitales útiles, bonitas y funcionales. Porque la belleza también importa."], ["Qué hacemos", "Desarrollamos proyectos digitales con cuidado, elegancia y atención a los detalles. Para nosotros, la calidad y la responsabilidad siempre son lo primero."], ["Cómo trabajamos", "Trabajamos con plazos realistas, comunicación clara y una revisión cuidadosa en cada etapa. No entregamos solo por terminar: entregamos cuando el trabajo está realmente bien hecho."], ["Dónde trabajamos", "En el planeta Tierra y sus alrededores."]] },
  ...
  "zh-CN": {
    ...
    company: { eyebrow: "公司", title: "关于 Mediatrix Tech", description: "让创意与技术协同工作，连接品牌与人。", facts: [["我们是谁", "我们是一家家族企业，致力于将好创意转化为实用、美观且功能完善的数字解决方案。因为美也同样重要。"], ["我们做什么", "我们用心、优雅且注重细节地开发数字项目。对我们而言，质量与责任始终是第一位。"], ["我们的工作方式", "我们设定切合实际的时间安排，保持清晰沟通，并在每个阶段认真审核。我们不会为了完成而交付；只有真正做好了，才会交付。"], ["我们的服务范围", "地球及其周边地区。"]] },
