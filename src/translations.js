...
export const translations = {
  "pt-BR": {
    ...
    company: {
      ...
      facts: [
        ["Para quem trabalhamos", "Pequenas empresas, profissionais, eventos e negócios do agronegócio que precisam apresentar melhor seus serviços ou organizar processos."],
        ["O que entregamos", "Landing pages, sites institucionais, sistemas simples, conteúdo visual e soluções personalizadas."],
        ["Como trabalhamos", "Definimos o objetivo e o escopo, desenvolvemos em etapas e mantemos uma comunicação direta durante o projeto."],
        ["Onde atendemos", "Santa Maria e região, clientes em todo o Brasil e projetos remotos no exterior."],
      ],
    },
    contact: {
  ...
  en: {
    ...
    company: { eyebrow: "Company", title: "Technology applied to business goals.", description: "Mediatrix Tech combines development, content and direct communication to turn real needs into useful digital solutions.", facts: [["Who we work with", "Small businesses, service providers, events and agricultural companies that need to present their work or improve a process."], ["What we deliver", "Landing pages, company websites, simple systems, visual content and custom digital solutions."], ["How we work", "We define the goal and scope, build in clear stages and communicate directly throughout the project."], ["Where we work", "Remote-first service for clients in Brazil, the United States and worldwide."]] },
    contact: {
  ...
  fr: {
    ...
    company: { eyebrow: "Entreprise", title: "À propos de Mediatrix Tech", description: "Créativité et technologie réunies pour rapprocher les marques et les personnes.", facts: [["Qui sommes-nous ?", "Une entreprise technologique et créative axée sur des solutions numériques utiles."], ["Ce que nous faisons", "Nous réunissons développement web et édition visuelle dans une prestation cohérente."], ["Notre méthode", "Nous comprenons l’objectif, simplifions le parcours et restons à vos côtés."], ["Où intervenons-nous ?", "La planète Terre et ses environs."]] },
  ...
  "zh-CN": {
    ...
    company: { eyebrow: "公司", title: "关于 Mediatrix Tech", description: "让创意与技术协同工作，连接品牌与人。", facts: [["我们是谁", "一家专注于实用数字解决方案的科技与创意公司。"], ["我们做什么", "将网站开发与视觉编辑整合为统一、连贯的服务。"], ["我们的工作方式", "理解目标、简化流程，并与您保持紧密沟通。"], ["我们的服务范围", "地球及其周边地区。"]] },
  ...
  ar: {
    ...
    company: { eyebrow: "الشركة", title: "عن Mediatrix Tech", description: "الإبداع والتقنية يعملان معًا لربط العلامات التجارية بالناس.", facts: [["من نحن", "شركة تقنية وإبداعية تركز على حلول رقمية مفيدة."], ["ما نفعله", "نجمع تطوير المواقع والتحرير البصري في خدمة متكاملة ومتناسقة."], ["كيف نعمل", "نفهم الهدف، ونبسّط الطريق، ونبقيك على اطلاع في كل خطوة."], ["أين نعمل", "كوكب الأرض وما حوله."]] },
