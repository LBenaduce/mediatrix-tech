...
export const translations = {
  "pt-BR": {
    ...
    hero: {
      ...
      title: "Sites profissionais para empresas que querem ser encontradas e conquistar mais clientes",
      description: "Criamos sites rápidos, responsivos e personalizados para pequenas empresas, profissionais, eventos e negócios do agronegócio em Santa Maria, no Brasil e no exterior.",
  ...
  en: {
    ...
    hero: { logoAlt: "Mediatrix Tech logo", title: "Professional websites built to help small businesses grow", description: "We build fast, responsive and personalized websites for small businesses, service providers, events and agricultural companies in the United States and worldwide.", primaryCta: "Request a free website review", secondaryCta: "View our work" },
