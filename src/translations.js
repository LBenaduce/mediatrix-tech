...
export const translations = {
  "pt-BR": {
    ...
    hero: {
      ...
      title: "Sites criados para impulsionar o seu negócio.",
      description: "Mais clientes. Mais receita. Crescimento da receita até 27% mais rápido.*",
    ...
    services: [
      { id: "site", title: "Sites profissionais e institucionais", description: "Sites rápidos e responsivos para explicar seus serviços, fortalecer a confiança e facilitar o contato.", benefit: "Uma presença digital própria, clara e preparada para crescer." },
      ...
      { id: "custom", title: "Sistemas e soluções personalizadas", description: "Ferramentas simples, formulários, painéis e fluxos digitais desenvolvidos conforme a rotina da empresa.", benefit: "Menos trabalho manual e uma operação mais organizada." },
      { id: "media", title: "Edição de imagens, vídeos e áudio", description: "Tratamento de conteúdo para produtos, eventos, redes sociais, apresentações e materiais institucionais.", benefit: "Comunicação visual e sonora mais profissional e consistente." },
      { id: "event", title: "Páginas para eventos com QR Code", description: "Experiências personalizadas para convidados enviarem, aprovarem e compartilharem fotos e vídeos.", benefit: "Participação simples pelo celular, sem exigir aplicativo." },
      { id: "agri", title: "Soluções digitais para o agronegócio", description: "Sites, painéis e experiências digitais para apresentar operações, dados e serviços do setor agrícola.", benefit: "Tecnologia aplicada a informações úteis para o campo e para o negócio." },
      { id: "care", title: "Manutenção e atualização de sites", description: "Ajustes de conteúdo, melhorias técnicas e acompanhamento para manter o site seguro e atual.", benefit: "Seu site continua funcionando bem depois da entrega." },
    ],
  ...
  en: {
    ...
    hero: { logoAlt: "Mediatrix Tech logo", title: "Websites Built to Grow Your Business", description: "More clients. More income. Up to 27% faster revenue growth.*", footnote: "*Based on Deloitte Access Economics research comparing advanced digitally engaged SMBs with offline businesses.", primaryCta: "Request a free website review", secondaryCta: "View our work" },
    ...
    services: [
      ...
      { id: "custom", title: "Custom systems and digital solutions", description: "Simple tools, forms, dashboards and workflows developed around the way your business operates.", benefit: "Less manual work and a more organized process." },
      { id: "media", title: "Image, video and audio editing", description: "Professional content editing for products, events, social media, presentations and company materials.", benefit: "More consistent visual and audio communication." },
      { id: "event", title: "QR Code event websites", description: "Custom experiences for guests to upload, approve and share photos and videos from their phones.", benefit: "Simple participation without requiring an app." },
      { id: "agri", title: "Digital solutions for agriculture", description: "Websites, dashboards and digital experiences that present agricultural operations, services and data.", benefit: "Technology applied to useful information for the field and the business." },
      { id: "care", title: "Website maintenance and updates", description: "Content changes, technical improvements and ongoing care to keep your website current and reliable.", benefit: "Your website keeps working well after launch." },
    ],
    ...
    company: { eyebrow: "Company", title: "Technology applied to business goals.", description: "Mediatrix Tech combines development, content and direct communication to turn real needs into useful digital solutions.", localSeo: { text: "Mediatrix Tech develops websites and digital solutions for businesses in Santa Maria, Rio Grande do Sul, other regions of Brazil and worldwide.", link: "Website development in Santa Maria, RS" }, facts: [["Who we are", "We are a family business, created to turn good ideas into useful, beautiful and functional digital solutions. Because beauty matters too."], ["What we do", "We develop digital projects with care, elegance and attention to detail. For us, quality and responsibility always come first."], ["How we work", "We work with realistic timelines, clear communication and careful review at every stage. We do not deliver just to finish: we deliver when the work is truly well done."], ["Where we work", "On planet Earth and its surroundings."]] },
    contact: {
  ...
  es: {
    ...
    hero: { logoAlt: "Logotipo de Mediatrix Tech", title: "Tecnología y contenido que impulsan tu marca.", description: "Más clientes. Más ingresos. Crecimiento de los ingresos hasta un 27 % más rápido.*", footnote: "*Basado en una investigación de Deloitte Access Economics que compara pymes con una presencia digital avanzada con empresas sin presencia en línea.", services: "Ver servicios" },
  ...
  fr: {
    ...
    hero: { logoAlt: "Logo de Mediatrix Tech", title: "La technologie et le contenu qui font avancer votre marque.", description: "Plus de clients. Plus de revenus. Une croissance du chiffre d’affaires jusqu’à 27 % plus rapide.*", footnote: "*D’après une étude de Deloitte Access Economics comparant les PME très avancées sur le plan numérique aux entreprises hors ligne.", services: "Voir les services" },
  ...
  de: {
    ...
    hero: { logoAlt: "Logo von Mediatrix Tech", title: "Technologie und Inhalte, die Ihre Marke voranbringen.", description: "Mehr Kunden. Mehr Umsatz. Bis zu 27 % schnelleres Umsatzwachstum.*", footnote: "*Basierend auf einer Studie von Deloitte Access Economics, die digital fortschrittliche KMU mit Offline-Unternehmen vergleicht.", services: "Leistungen ansehen" },
  ...
  "zh-CN": {
    ...
    hero: { logoAlt: "Mediatrix Tech 标志", title: "以技术与内容推动您的品牌向前。", description: "更多客户。更多收入。营收增长速度最高可提升 27%。*", footnote: "*基于 Deloitte Access Economics 的研究，该研究将数字化参与度高的中小企业与离线经营的企业进行了比较。", services: "查看服务" },
  ...
  hi: {
    ...
    hero: { logoAlt: "Mediatrix Tech का लोगो", title: "तकनीक और कंटेंट जो आपके ब्रांड को आगे बढ़ाएँ।", description: "ज़्यादा ग्राहक। ज़्यादा आय। राजस्व वृद्धि 27% तक तेज़।*", footnote: "*Deloitte Access Economics के शोध पर आधारित, जिसमें डिजिटल रूप से उन्नत लघु और मध्यम व्यवसायों की तुलना ऑफ़लाइन व्यवसायों से की गई है।", services: "सेवाएँ देखें" },
  ...
  ar: {
    ...
    hero: { logoAlt: "شعار Mediatrix Tech", title: "تقنية ومحتوى يدفعان بعلامتك التجارية إلى الأمام.", description: "المزيد من العملاء. المزيد من الإيرادات. نمو في الإيرادات أسرع بنسبة تصل إلى 27%.*", footnote: "*استنادًا إلى بحث أجرته Deloitte Access Economics يقارن الشركات الصغيرة والمتوسطة ذات التفاعل الرقمي المتقدم بالشركات غير المتصلة بالإنترنت.", services: "عرض الخدمات" },
