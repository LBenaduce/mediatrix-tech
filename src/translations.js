...
export const translations = {
  "pt-BR": {
    ...
    projects: [
      ...
      { name: "Itamec Mecânica", category: "Desenvolvimento Web · Serviços Automotivos", description: "Site responsivo para apresentar os serviços da oficina e facilitar o contato com clientes da região." },
    ],
    company: {
      ...
      facts: [
        ...
        ["Como trabalhamos", "Entendemos o objetivo, simplificamos o caminho e mantemos você envolvido em todas as etapas."],
  ...
  en: {
    ...
    projects: [
      ...
      { name: "Itamec Auto Repair", category: "Web Development · Automotive Services", description: "A responsive website presenting the repair shop’s services and making it easy for local customers to get in touch." },
    ],
    ...
    contact: {
      eyebrow: "Contact", title: "Let’s talk about your project.", description: "Choose the easiest channel or send us a message through the form.", channelsLabel: "Contact channels",
  ...
  "zh-CN": {
    ...
    projects: [{ name: "AgriClimate Pro", category: "网站开发 · 农业科技", description: "利用气候数据辅助农业决策的数字化体验。" }, { name: "Frasson LLC", category: "网站开发", description: "简洁的企业网站，用于展示服务并方便客户联系。" }, { name: "Event QR Code", category: "活动数字体验", description: "宾客可通过二维码轻松上传照片和视频。" }, { name: "Cafeteria", category: "网站开发 · 餐饮", description: "温馨的响应式网站，展示咖啡馆体验并让访客轻松查看菜单。" }, { name: "Itamec 汽车维修", category: "网站开发 · 汽车服务", description: "响应式网站，用于展示维修服务并方便本地客户联系。" }],
